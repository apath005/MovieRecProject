...
to overload classes when looking for movie recommendations and we believe that Composite and visitor combo will allow us to overcome that issue. The visitor pattern will
